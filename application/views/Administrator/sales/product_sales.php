						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group" :style="{display: selectedProduct.Unit_Name != 'PCS' ? '' : 'none'}">
									...
									<div class="col-xs-5">
										<input type="number" step="0.01" id="size_w" class="form-control" ref="size_w" v-model="selectedProduct.size_w" v-on:input="sizeTotal" autocomplete="off" :required="selectedProduct.Unit_Name != 'PCS'"/>
									</div>
									<div class="col-xs-4">
										<input type="number" step="0.01" id="size_h" class="form-control" ref="size_h" v-model="selectedProduct.size_h" v-on:input="sizeTotal" autocomplete="off" :required="selectedProduct.Unit_Name != 'PCS'"/>
									</div>
								</div>
								<div class="form-group" :style="{display: selectedProduct.Unit_Name != 'PCS' ? '' : 'none'}">
									<label class="col-xs-3 control-label no-padding-right"> Color </label>
									<div class="col-xs-9">
										<input type="number" step="0.01" placeholder="color" class="form-control" v-model="selectedProduct.color" v-on:input="sizeTotal" autocomplete="off" :required="selectedProduct.Unit_Name != 'PCS'" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 control-label no-padding-right"> Quantity </label>
									<div class="col-xs-9">
										<input type="number" step="0.01" id="quantity" placeholder="Qty" class="form-control" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" required :readonly="selectedProduct.Unit_Name != 'PCS'" />
									</div>
								</div>
